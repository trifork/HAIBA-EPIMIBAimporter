...
CREATE TABLE IF NOT EXISTS Tabmicroorganism (
	   TabmicroorganismId BIGINT(15) AUTO_INCREMENT NOT NULL PRIMARY KEY,
       Banr varchar(50),
       Text varchar(300)
) ENGINE=InnoDB COLLATE=utf8_bin;

CREATE TABLE IF NOT EXISTS TabLabSection (
	   TabLabSectionId BIGINT(15) AUTO_INCREMENT NOT NULL PRIMARY KEY,
       Avd varchar(50),
       Text varchar(300)
) ENGINE=InnoDB COLLATE=utf8_bin;

CREATE TABLE IF NOT EXISTS TabOrganization (
	   TabOrganizationId BIGINT(15) AUTO_INCREMENT NOT NULL PRIMARY KEY,
       Mgkod varchar(300),
       Text varchar(300)
) ENGINE=InnoDB COLLATE=utf8_bin;

CREATE TABLE IF NOT EXISTS TabAnalysis (
	   TabAnalysisId BIGINT(15) AUTO_INCREMENT NOT NULL PRIMARY KEY,
       Qtnr varchar(300),
       Text varchar(300)
) ENGINE=InnoDB COLLATE=utf8_bin;

CREATE TABLE IF NOT EXISTS TabInvestigation (
	   TabInvestigationId BIGINT(15) AUTO_INCREMENT NOT NULL PRIMARY KEY,
       Usnr varchar(50),
       Text varchar(300)
) ENGINE=InnoDB COLLATE=utf8_bin;

CREATE TABLE IF NOT EXISTS TabLocation (
	   TabLocationId BIGINT(15) AUTO_INCREMENT NOT NULL PRIMARY KEY,
       Alnr varchar(200),
       Text varchar(300)
) ENGINE=InnoDB COLLATE=utf8_bin;
